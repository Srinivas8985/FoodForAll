...
import { CheckCircle, XCircle, FileText, Calendar, MapPin, Building, Phone, Mail, Clock, MessageSquare } from 'lucide-react';
                            ...
                            <div className="grid md:grid-cols-2 gap-8 mb-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <button
                                            onClick={() => handleStartChat(selectedNGO._id)}
                                            className="w-full mt-4 flex items-center justify-center gap-2 py-2 bg-indigo-50 text-indigo-700 rounded-lg hover:bg-indigo-100 transition-colors text-sm font-medium"
                                        >
                                            <MessageSquare size={16} /> Message Organization
                                        </button>
                                    </div>
                                </div>
                            </div>
